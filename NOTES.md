...
1. Update cdmplugins/sysinfo.cdmp with a new version, e.g. 1.0.1
2. Update ChangeLog
...
```shell
pip install --index-url https://test.pypi.org/simple/ cdmsysinfoplugin
```
10. Check the installed version
11. Uninstall the pypitest version
```shell
pip uninstall cdmsysinfoplugin
```
12. Upload to pypy
```shell
...
git push --tags
```
17. Publish the release on github at [releases](https://github.com/SergeySatskiy/cdm-sysinfo-plugin/releases)
